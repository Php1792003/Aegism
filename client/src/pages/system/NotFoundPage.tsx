...
const NotFoundPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-white to-blue-50 dark:from-slate-950 dark:via-[#070d18] dark:to-slate-900 flex items-center justify-center px-4 transition-colors">
            <div className="max-w-4xl w-full flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-16">
                ...
                <div className="w-full lg:w-1/2 flex justify-center animate-[float_6s_ease-in-out_infinite]">
                    <svg className="w-72 h-72 lg:w-80 lg:h-80" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                        {/* Background circle */}
                        <circle cx="200" cy="200" r="160" fill="#EBF5FF" className="dark:opacity-10" />
                        <circle cx="200" cy="200" r="120" fill="#DBEAFE" className="dark:opacity-10" />
                ...
                <div className="w-full lg:w-1/2 text-center lg:text-left space-y-5">
                    <div className="inline-block px-3 py-1 text-xs font-semibold tracking-wider text-blue-600 dark:text-blue-400 uppercase bg-blue-100 dark:bg-blue-950/60 rounded-full border border-blue-200 dark:border-blue-800">
                        Lỗi hệ thống
                    </div>

                    <h1 className="text-4xl lg:text-5xl font-extrabold text-gray-900 dark:text-white tracking-tight leading-tight">
                        Oops! Trang này<br />
                        <span className="text-blue-600 dark:text-blue-400">không tồn tại.</span>
                    </h1>
