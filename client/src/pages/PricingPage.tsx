                                    ...
                                    {paymentStep === 'waiting' && (
                                        <div className="absolute inset-0 bg-white z-10 flex flex-col items-center justify-center p-8 text-center">
                                            ...
                                            <div className="border-4 border-[#4F46E5] rounded-2xl p-3 bg-white shadow-lg inline-block mb-4">
                                                <img src={`https://img.vietqr.io/image/MB-5555517092003-compact2.png?amount=${calculateSubTotal()}&addInfo=AEGISM${selectedPlanKey.toUpperCase()}${orderCode}&accountName=AEGISM`} alt="VietQR" className="w-48 h-48 object-contain" />
                                            </div>
                                            {checkoutUrl && (
