        ...
        <div className="flex-1 flex flex-col overflow-hidden bg-transparent p-4 sm:p-6">
            ...
            <div className="max-w-7xl mx-auto w-full space-y-4 sm:space-y-6">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div className="w-full sm:w-auto relative">
                        <input
                            ...
                            className="w-full sm:w-72 pl-10 pr-4 py-2.5 sm:py-2 border border-[rgba(255,255,255,0.07)] bg-[rgba(17,17,27,0.8)] text-gray-300 placeholder-gray-500 rounded-lg focus:outline-none focus:border-purple-500 shadow-sm text-sm"
                        />
                ...
                <div style={{ background: 'rgba(17,17,27,0.8)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '14px', backdropFilter: 'blur(12px)' }} className="overflow-hidden">
                    ...
                    {/* Pagination */}
                    {totalPages > 1 && (
                        <div className="px-4 sm:px-6 py-4 border-t border-[rgba(255,255,255,0.05)] flex items-center justify-between bg-[rgba(255,255,255,0.02)]">
