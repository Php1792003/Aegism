                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                        ...
                        <div data-reveal="left" className="hidden lg:block lg:col-span-4 sticky top-24 bg-gray-50/80 dark:bg-slate-900/80 p-6 rounded-3xl border border-gray-200/80 dark:border-slate-800">
                            ...
                            <div className="mt-8 pt-6 border-t border-gray-200 dark:border-slate-800 text-xs text-gray-500 dark:text-gray-400 space-y-2">
                                <p className="font-bold text-gray-800 dark:text-slate-200">Cần ký hợp đồng pháp nhân?</p>
                                <p>Email: <a href="mailto:legal@aegism.online" className="text-blue-600 dark:text-blue-400 font-semibold hover:underline">legal@aegism.online</a></p>
                                <Link to="/policy" className="inline-flex items-center text-blue-600 dark:text-blue-400 font-bold hover:underline pt-2">
                        ...
                        <div data-reveal="right" className="lg:col-span-8 bg-white dark:bg-slate-900 p-8 sm:p-12 rounded-3xl border border-gray-200/80 dark:border-slate-800 shadow-sm space-y-10 text-gray-700 dark:text-slate-300 leading-relaxed text-sm">
                            <section id="chap-nhan-dieu-khoan" className="space-y-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h2 className="text-xl font-bold text-gray-900 dark:text-white">Chấp Nhận Điều Khoản</h2>
                                </div>
                                <p>
                            ...
                            <section id="tai-khoan-bao-mat" className="space-y-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h2 className="text-xl font-bold text-gray-900 dark:text-white">Quản Lý Tài Khoản & Quyền Bảo Mật</h2>
                                </div>
                                <p>
                                ...
                                <div className="p-4 bg-gray-50 dark:bg-slate-800/80 rounded-2xl border border-gray-100 dark:border-slate-700/50 flex items-start gap-3">
                                    <HiOutlineShieldCheck className="w-5 h-5 text-blue-600 dark:text-blue-400 flex-shrink-0 mt-0.5" />
                            ...
                            <section id="goi-dich-vu-thanh-toan" className="space-y-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h2 className="text-xl font-bold text-gray-900 dark:text-white">Gói Dịch Vụ, Hạn Ngạch & Thanh Toán</h2>
                                </div>
                                <p>
                            ...
                            <section id="cam-ket-sla" className="space-y-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h2 className="text-xl font-bold text-gray-900 dark:text-white">Cam Kết Chất Lượng Dịch Vụ (SLA)</h2>
                                </div>
                                <p>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                                    <div className="p-3.5 bg-blue-50/50 dark:bg-blue-950/40 rounded-xl border border-blue-100 dark:border-blue-800/60 text-xs">
                                        <p className="font-bold text-blue-900 dark:text-blue-200">Thời gian phản hồi sự cố nghiêm trọng:</p>
                                        <p className="text-blue-700 dark:text-blue-300 mt-1">Dưới 30 phút (24/7)</p>
                                    </div>
                                    <div className="p-3.5 bg-blue-50/50 dark:bg-blue-950/40 rounded-xl border border-blue-100 dark:border-blue-800/60 text-xs">
                                        <p className="font-bold text-blue-900 dark:text-blue-200">Hỗ trợ hướng dẫn kỹ thuật thông thường:</p>
                                        <p className="text-blue-700 dark:text-blue-300 mt-1">Dưới 2 giờ làm việc</p>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section id="so-huu-tri-tue" className="space-y-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h2 className="text-xl font-bold text-gray-900 dark:text-white">Sở Hữu Trí Tuệ</h2>
                                </div>
                                <p>
