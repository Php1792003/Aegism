                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                            ...
                            <div data-reveal="left" className="lg:col-span-5 space-y-6">
                                <div className="bg-white p-8 rounded-3xl border border-gray-200/80 shadow-sm space-y-6">
                                    <h3 className="text-xl font-bold text-gray-900">Thông Tin Liên Hệ Trực Tiếp</h3>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <p className="text-xs text-gray-500 font-semibold uppercase">Hotline tư vấn 24/7</p>
                                            <a href="tel:0905441263" className="text-lg font-black text-gray-900 hover:text-blue-600 transition">
                                                (+84) 905 441 263
                                            </a>
                                            <p className="text-xs text-gray-400 mt-0.5">Hỗ trợ khẩn cấp cả ngày lễ & chủ nhật</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <p className="text-xs text-gray-500 font-semibold uppercase">Email tiếp nhận yêu cầu</p>
                                            <a href="mailto:support@aegism.online" className="text-base font-bold text-gray-900 hover:text-blue-600 transition">
                                                support@aegism.online
                                            </a>
                                            <p className="text-xs text-gray-400 mt-0.5">Phản hồi trong vòng 2 giờ làm việc</p>
                                        </div>
                                    </div>

                                    <div className="flex items-start gap-4">
                                        <div className="w-12 h-12 rounded-2xl bg-sky-50 text-cyan-600 flex items-center justify-center flex-shrink-0">
                                            <HiMapPin className="w-6 h-6" />
                                        </div>
                                        <div>
                                            <p className="text-xs text-gray-500 font-semibold uppercase">Trụ sở phát triển</p>
                                    ...
                                    <div className="flex items-start gap-4 border-t border-gray-100 pt-5">
                                        ...
                                        <div>
                                            <p className="text-xs text-gray-500 font-semibold uppercase">Thời gian làm việc</p>
                                            <p className="text-xs text-gray-700 font-medium">Thứ 2 - Thứ 6: 08:00 - 17:30</p>
                                            <p className="text-xs text-gray-700 font-medium">Thứ 7: 08:00 - 12:00</p>
                                        </div>
                                    </div>
                                </div>

                                {/* Map Widget */}
                                <div data-reveal="scale" className="bg-white p-2.5 rounded-3xl border border-gray-200/80 shadow-sm overflow-hidden h-64">
                                    <iframe
                            ...
                            <div data-reveal="right" className="lg:col-span-7">
                                <div className="bg-white p-8 sm:p-10 rounded-3xl border border-gray-200/80 shadow-lg relative">
                                    ...
                                    <h3 className="text-2xl font-black text-gray-900 mt-3 mb-2">Để Lại Tin Nhắn Cho Chúng Tôi</h3>
                                    <p className="text-sm text-gray-500 mb-8">Điền thông tin vào mẫu bên dưới, chuyên viên phụ trách sẽ liên hệ lại với bạn sớm nhất.</p>

                                    <form onSubmit={handleSubmit} className="space-y-5">
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                            <div>
                                                <label htmlFor="name" className="block text-xs font-bold text-gray-700 mb-1.5">Họ và tên *</label>
                                                <input type="text" id="name" required value={formData.name} onChange={e => setFormData({ ...formData, name: e.target.value })} placeholder="Nguyễn Văn A" className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-blue-600 outline-none text-sm" />
                                            </div>
                                            <div>
                                                <label htmlFor="email" className="block text-xs font-bold text-gray-700 mb-1.5">Email công việc *</label>
                                                <input type="email" id="email" required value={formData.email} onChange={e => setFormData({ ...formData, email: e.target.value })} placeholder="email@company.com" className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-blue-600 outline-none text-sm" />
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                            ...
                                            <div>
                                                <label htmlFor="subject" className="block text-xs font-bold text-gray-700 mb-1.5">Nhu cầu của bạn</label>
                                                <select id="subject" value={formData.subject} onChange={e => setFormData({ ...formData, subject: e.target.value })} className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-blue-600 outline-none text-sm bg-white cursor-pointer">
                                        ...
                                        <div>
                                            <label htmlFor="message" className="block text-xs font-bold text-gray-700 mb-1.5">Nội dung chi tiết</label>
                                            <textarea id="message" rows={4} value={formData.message} onChange={e => setFormData({ ...formData, message: e.target.value })} placeholder="Mô tả quy mô mục tiêu, số lượng bảo vệ hoặc yêu cầu đặc thù của bạn..." className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-blue-600 outline-none text-sm resize-none" />
                                        </div>
            ...
            {modalState.isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/60 backdrop-blur-sm p-4">
                    <div className="bg-white rounded-3xl max-w-md w-full p-8 text-center shadow-2xl">
                        <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 ${modalState.type === 'success' ? 'bg-emerald-100 text-emerald-600' : 'bg-rose-100 text-rose-600'}`}>
